...
4. Abrir el PR contra `main`, completar la plantilla, incluir `Closes #N` y solicitar revisión a `@DS-2026-grupo18/reviewers`.
...
`https://github.com/DS-2026-grupo18/SmartPantry/compare/main...feature/<numero-issue>-<descripcion-corta>?expand=1`
